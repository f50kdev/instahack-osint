...
const PhoneLookupEnhanced = () => {
  ...
  return (
    <div className="bg-gray-900 rounded-lg p-6 mb-6">
      <h2 className="text-2xl font-bold text-white mb-4">📱 Phone Lookup (Truecaller Style)</h2>
      ...
      {phoneInfo && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gray-800 rounded-lg p-4">
            <h3 className="text-lg font-semibold text-white mb-3">📞 Informações do Telefone</h3>
          ...
          <div className="bg-gray-800 rounded-lg p-4 md:col-span-2">
            <h3 className="text-lg font-semibold text-white mb-3">👤 Informações do Proprietário (Truecaller Style)</h3>
            <div className="space-y-2 text-gray-300">
      ...
      <div className="mt-6 p-4 bg-gray-800 rounded-lg">
        <h4 className="text-white font-semibold mb-2">💡 Informações sobre busca de telefones:</h4>
...
export default PhoneLookupEnhanced; 